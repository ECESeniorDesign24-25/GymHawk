These are some scripts I have been using to test comms and flashing from my computer. Check the comments to update the locations and names to whatever your computer uses.
